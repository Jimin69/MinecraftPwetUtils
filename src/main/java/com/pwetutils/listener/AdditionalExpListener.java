...
public class AdditionalExpListener {
    ...
    public static String getStarsGained() {
        ...
        double truncatedStars = Math.floor(stars * 100) / 100;
        String formatted = String.format("%.2f", truncatedStars);
        ...
        if (stars >= 20.00) {
            ...
            return String.format("§8✪§5%.2f", truncatedStars);
        } else if (stars >= 18.00) {
            return String.format("§1✪§9%.2f", truncatedStars);
        } else if (stars >= 17.00) {
            return String.format("§5✪§d%.2f", truncatedStars);
        } else if (stars >= 16.00) {
            return String.format("§4✪§c%.2f", truncatedStars);
        } else if (stars >= 15.00) {
            return String.format("§9✪§3%.2f", truncatedStars);
        } else if (stars >= 14.00) {
            return String.format("§2✪§a%.2f", truncatedStars);
        } else if (stars >= 13.00) {
            return String.format("§3✪§b%.2f", truncatedStars);
        } else if (stars >= 12.00) {
            return String.format("§6✪§e%.2f", truncatedStars);
        } else if (stars >= 11.00) {
            return String.format("§7✪§f%.2f", truncatedStars);
        } else if (stars >= 10.00) {
            return "§d✫§c" + formatted.charAt(0) + "§6" + formatted.charAt(1) + "§e" + formatted.charAt(2) + "§a" + formatted.charAt(3) + "§b" + formatted.charAt(4);
        } else if (stars >= 9.00) {
            return String.format("§5✫%.2f", truncatedStars);
        } else if (stars >= 8.00) {
            return String.format("§9✫%.2f", truncatedStars);
        } else if (stars >= 7.00) {
            return String.format("§d✫%.2f", truncatedStars);
        } else if (stars >= 6.00) {
            return String.format("§4✫%.2f", truncatedStars);
        } else if (stars >= 5.00) {
            return String.format("§3✫%.2f", truncatedStars);
        } else if (stars >= 4.00) {
            return String.format("§2✫%.2f", truncatedStars);
        } else if (stars >= 3.00) {
            return String.format("§b✫%.2f", truncatedStars);
        } else if (stars >= 2.00) {
            return String.format("§2✫%.2f", truncatedStars);
        } else if (stars >= 1.00) {
            return String.format("§f✫%.2f", truncatedStars);
        } else {
            return String.format("§7✫%.2f", truncatedStars);
        }
    }
